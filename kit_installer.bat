...
SET REPO_DEPENDENCIES_URL=https://github.com/kandi1clickkits/Emojinator/main/requirements.txt
SET REPO_NAME=Emojinator.zip
SET EXTRACTED_REPO_DIR=emojinator
SET NOTEBOOK_NAME=Emojinator-notebook.ipynb
SET MS_VC_REDIST_URL=https://aka.ms/vs/17/release/vs_BuildTools.exe
SET GET_PIP_LOCATION=https://bootstrap.pypa.io/get-pip.py
SET VIRTUALENV_NAME=emoji-detection-kit-env
